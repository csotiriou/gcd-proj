...
/**
 Common functions for running unit tests and returning thingies. Useful for setting up logging both in the main application and the unit tests, which is bundle-wide. This singleton is not tested ("how many tests would a unit test test if a unit test could test tests?")
